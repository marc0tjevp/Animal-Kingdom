        ...
        <nav class="navbar navbar-inverse navbar-static-top">
            ...
            <div class="collapse navbar-collapse" id="navbar-test">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="propagate">Propagate</a></li>
                </ul>
            </div>
        </nav>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-12 col-xs-12">
                            <div class="dropdown">
                                <button class="btn btn-primary dropdown-toggle pull-left" style="margin-right: 6px; min-width: 80px;" type="button" data-toggle="dropdown"><i class="fa fa-filter"></i> ${species}
                            ...
                            <button class="btn btn-primary"  data-toggle="modal" data-target="#options"><i class="fa fa-cog"></i> Options</button>
                            <a class="btn btn-primary" id="propBtn"><i class="fa fa-bed"></i> Propagate</a>
                            <c:forEach items="${table}" var="listItem">
                                <c:if test="${listItem.isPregnant()}">
                                    <form action="layEggs"  class="pull-right">
                                        <input type="text" class="hide" id="thisAnimal" name="thisAnimal" value="${listItem.getID()}">
                                        <button type="submit" style="margin-right: 5px;" class="btn btn-primary pull-right">Lay Eggs</button>
                                    </form>
                                    <form action="giveBirth"  class="pull-right">
                                        <input type="text" class="hide" id="thisAnimal" name="thisAnimal" value="${listItem.getID()}">
                                        <button type="submit" style="margin-right: 5px;" class="btn btn-primary pull-right">Give Birth</button>
                                    </form>
                                </c:if>
                            </c:forEach>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <table class="table table-bordered noselect" id="selection1">
                        ...
                        <c:forEach items="${table}" var="listItem">
                            <tr  class="male" data-uuid="${listItem.getID()}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="change" method="post">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="fa fa-floppy-disk-o"></i> Save</button>
                                <button type="button" class="btn btn-default pull-right" data-dismiss="modal"><span class="glyphicon glyphicon-ok"></span> Close</button>
                            </form>
                        </div>
                    </div>
                </div>
